...
import com.infinitysoftware.roomdb_contactlistapp.viewmodel.SortType
import com.infinitysoftware.roomdb_contactlistapp.viewmodel.events.ContactEvent

@Composable
fun ContactScreen(state: ContactState, onEvent: (ContactEvent) -> Unit, modifier: Modifier = Modifier) {
    Scaffold(
        floatingActionButton = { FloatingActionButton( onClick = { onEvent(ContactEvent.ShowDialog) } ) {
